...
return [
        'pageTitle' => 'Calendar',
        'pageDescription' => 'Upcoming Mud Monkeys trail trips and running weekends.',
        'currentPage' => 'calendar',
        'renderContent' => static function () use ($events): void {
            ?>
            ...
            <section class="container py-5">
                ...
                <aside class="join-panel rounded-4 p-4 p-lg-5 mt-5">
                    <div class="row align-items-center g-4">
                        <div class="col-lg-4">
                            <span class="badge rounded-pill text-bg-warning mb-3">Flexible options</span>
